...
static void usage(FILE *fp) {
    fprintf(fp,
        ...
        "  --cpu-moe\n"
        "      Compute routed MoE experts on the CPU. Metal keeps their weights out of\n"
        "      the residency set; CUDA stages router inputs/results across PCIe and can\n"
        "      combine this with the partial weight cache for dense GPU residency.\n"
